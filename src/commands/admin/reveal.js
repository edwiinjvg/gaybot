  ...
  handle: async ({
    ...
    if (!isImage && !isVideo) {
      throw new InvalidParameterError(
        "_¡Necesitas responder a una imagen o video para revelarlo!_"
      );
    }

    await sendWaitReact();

    const mediaCaption = `_¡Aquí está tu ${
      isImage ? "imagen revelada" : "video revelado"
    }!_`;
    ...
    try {
      ...
      throw new Error(
        "_Ocurrió un error al procesar el medio. Inténtalo de nuevo._"
      );
    } finally {
