...
module.exports = {
  name: "addmoney",
  description: "Añade monedas a tu cuenta o a la de un usuario mencionado. Solo para el propietario del bot.",
  commands: ["addmoney", "am"],
  usage: `${getPrefix()}addmoney <cantidad> [@usuario]`,
  /**
